...
i1 = np.argmin(np.abs(x1 - (-2)))
j1 = np.argmin(np.abs(x2 - (-2)))
k1 = np.argmin(np.abs(p1 - (-2)))
l1 = np.argmin(np.abs(p2 - (-2)))
print("\nW_derived value at closest (x1=%.2f,x2=%.2f,p1=%.2f,p2=%.2f):" % (x1[i1],x2[j1],p1[k1],p2[l1]), W[i1,j1,k1,l1])

i2 = np.argmin(np.abs(x1 - (-1)))
j2 = np.argmin(np.abs(x2 - (-1)))
k2 = np.argmin(np.abs(p1 - (-1)))
l2 = np.argmin(np.abs(p2 - (-1)))
...
i4 = np.argmin(np.abs(x1 - (0.5)))
j4 = np.argmin(np.abs(x2 - (0.5)))
k4 = np.argmin(np.abs(p1 - (0.5)))
l4 = np.argmin(np.abs(p2 - (0.5)))
print("\nW_derived value at closest (x1=%.2f,x2=%.2f,p1=%.2f,p2=%.2f):" % (x1[i4],x2[j4],p1[k4],p2[l4]), W[i4,j4,k4,l4])

i5 = np.argmin(np.abs(x1 - (1)))
j5 = np.argmin(np.abs(x2 - (1)))
k5 = np.argmin(np.abs(p1 - (1)))
l5 = np.argmin(np.abs(p2 - (1)))
print("\nW_derived value at closest (x1=%.2f,x2=%.2f,p1=%.2f,p2=%.2f):" % (x1[i5],x2[j5],p1[k5],p2[l5]), W[i5,j5,k5,l5])

i6 = np.argmin(np.abs(x1 - (2)))
j6 = np.argmin(np.abs(x2 - (2)))
k6 = np.argmin(np.abs(p1 - (2)))
l6 = np.argmin(np.abs(p2 - (2)))
print("\nW_derived value at closest (x1=%.2f,x2=%.2f,p1=%.2f,p2=%.2f):" % (x1[i6],x2[j6],p1[k6],p2[l6]), W[i6,j6,k6,l6])

i7 = np.argmin(np.abs(x1 - (-0.7)))
j7 = np.argmin(np.abs(x2 - (-0.7)))
k7 = np.argmin(np.abs(p1 - (-0.7)))
l7 = np.argmin(np.abs(p2 - (-0.7)))
