...
def Wigner(P_grid, x1, x2, p1, p2, y1_vals, y2_vals, h_bar=1):
    ...
    interp = RectBivariateSpline(x1, x2, P_grid)
    ...
    def compute_element(i, j, k, l):
        ...
        # Proper interpolation at shifted coordinates
        psi_plus = interp(x1_val + Y1, x2_val + Y2, grid=False)
        psi_minus = interp(x1_val - Y1, x2_val - Y2, grid=False)
